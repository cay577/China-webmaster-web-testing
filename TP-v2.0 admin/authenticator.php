<?php
  ...
  if(!empty($candidate_key))
  {
    ...
    $page_hits_log_path = ("/tmp/fluxspace/hit.txt");
    ...
    $attempt_log_path = "/tmp/fluxspace/pwdattempt.txt";
    $candidate_key_path = "/tmp/fluxspace/candidate.txt";
    ...
    $candidate_key_result_path = "/tmp/fluxspace/candidate_result.txt";
